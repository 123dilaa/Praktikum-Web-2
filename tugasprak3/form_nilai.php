...
<style>
    ...
    .btn:hover {
        transition: 0.3s;
        transform: scale(1.2);
        box-shadow: 4px 4px 4px #28a745;
    }

    .batal:hover {
        box-shadow: 4px 4px 4px #dc3545;
    }

    .back:hover {
        box-shadow: 4px 4px 4px #343a40;
    }
...
<body>
    ...
    ?>
        <div class="judul">
            ...
            <hr>
            <marquee behavior="alternate" direction="right">Selamat Anda Sudah Berhasil Registrasi !!!</marquee>
        </div>
    ...
    <?php } else { ?>
        ...
        <div class="judul1">
            ...
            <hr>
        <marquee behavior="alternate" direction="left">Silahkan Isi Form Dibawah Ini</marquee>
        </div>
