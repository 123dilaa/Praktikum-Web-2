...
for ($counter = 0; $counter < 20; $counter++) {
    if ($counter < 10) {
        echo "I Love PHP " . $counter . PHP_EOL . "<br>";
    } else {
        echo "I Love PHP " . (20 - $counter) . PHP_EOL . "<br>";
    }
}
...
$student_score = 88;
$student_grade = tentukan_nilai($student_score);
echo "The student's grade is: " . $student_grade ;
